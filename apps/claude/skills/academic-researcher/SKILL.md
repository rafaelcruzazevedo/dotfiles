...
description: 'Academic research assistant for literature reviews, paper analysis, and scholarly writing. This skill should be used when the user asks to "review a paper", "conduct a literature review", "analyze methodology", "format citations", or mentions academic research or scientific literature.'
metadata:
  author: rafazsh
  version: "1.0.0"
---
