---
name: deep-research
description: 'Comprehensive research assistant that synthesizes information from multiple sources with citations. This skill should be used when the user asks to "research this topic", "investigate", "find sources", "synthesize information", or needs in-depth analysis with citations.'
metadata:
  author: rafazsh
  version: "1.0.0"
---
