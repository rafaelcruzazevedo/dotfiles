...
description: 'Chart selection and data visualization guidance for effective data communication. This skill should be used when the user asks to "create a chart", "visualize data", "choose a chart type", "design a dashboard", or needs help presenting data visually.'
metadata:
  author: rafazsh
  version: "1.0.0"
---
