...
description: 'Creates clear documentation, API references, guides, and technical content. This skill should be used when the user asks to "write documentation", "create a README", "document this API", "write a tutorial", or needs help with technical writing and user guides.'
metadata:
  author: rafazsh
  version: "1.0.0"
---
