...
description: 'Breaks down complex projects into actionable tasks with timelines, dependencies, and milestones. This skill should be used when the user asks to "plan a project", "create a roadmap", "break down tasks", "estimate timelines", or mentions project planning and work breakdown.'
metadata:
  author: rafazsh
  version: "1.0.0"
---
